...
class fetch:
  ...
  def applyAction(self, motorCommands):
    ...
    if (self.useInverseKinematics):
      ...
      print("FF", state[0], state[0])
      # print("act_ee_1", self.endEffectorPos)

      self.endEffectorPos[0] = self.endEffectorPos[0]+dx
      if (self.endEffectorPos[0]>0.84):
        self.endEffectorPos[0]=0.84
      if (self.endEffectorPos[0]<0.2):
        self.endEffectorPos[0]=0.2
      self.endEffectorPos[1] = self.endEffectorPos[1]+dy
      if (self.endEffectorPos[1] < -0.35):
        self.endEffectorPos[1]= -0.35
      if (self.endEffectorPos[1] > 0.35):
        self.endEffectorPos[1] = 0.35

      self.endEffectorPos[2] = self.endEffectorPos[2] + dz
      if actualEndEffectorPos[2] < 0.39:
        self.endEffectorPos[2] = 0.39
      if actualEndEffectorPos[2] > 0.8:
        self.endEffectorPos[2] = 0.8 #self.endEffectorPos[2]+0.0001

      # print("act_ee_2", self.endEffectorPos)
