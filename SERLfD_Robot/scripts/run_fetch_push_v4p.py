...
from envs.fetch.pushing_env_4_fetch import fetchGraspingProceduralEnv
# configurations
...
parser.add_argument(
    "--robot-env-config",
    type=str,
    default=os.getcwd() + "/../config/fetch_serl_push_env_2.yaml",
...
def main():
    ...
    env = fetchGraspingProceduralEnv(render_mode='DIRECT', render_width=640, render_height=480, downsample_width=120, downsample_height=90, camera_random=1.0)
