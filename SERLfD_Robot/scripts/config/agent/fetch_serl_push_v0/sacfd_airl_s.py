...
from algorithms.fd.sac_mlp_agent_airl import Agent
...
def get(env, args):
    ...
    if hyper_params["STATES_WITH_UTILITIES"]:
        ...
        simple_states_dim_policy = simple_states_dim
    ...
    models = (actor, vf, vf_target, qf_1, qf_2, value_net, reward_net)
    optims = (actor_optim, vf_optim, qf_1_optim, qf_2_optim, value_net_optim, reward_net_optim)
