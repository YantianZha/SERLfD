...
class Agent(SACAgent):
    ...
    def update_model(self, experiences):
        ...
        # BUG: https://discuss.pytorch.org/t/solved-pytorch1-5-runtimeerror-one-of-the-variables-needed-for-gradient-computation-has-been-modified-by-an-inplace-operation/90256/4
        # # train Q functions
        ...
        if self.total_step % self.hyper_params["DELAYED_UPDATE"] == 0:
            ...
            actor_loss = torch.mean(actor_loss_element_wise * weights) + actor_reg
