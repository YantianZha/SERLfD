...
class Agent(AbstractAgent):
    ...
    def __init__(self, env, args, hyper_params, models, optims, noises, sparse=False):
        ...
        self.train_img_folder = os.getcwd() + '/../data/fetch-' + self.args.algo + '_' + ts
    ...
    def train(self):
        ...
        for i_episode in range(1, self.args.episode_num + 1):
            ...
            t_next_state = draw_predicates_on_img(state, self.hyper_params["SIMPLE_STATES_SIZE"], (640, 480), reward,
                                                  done)
            ...
            if loss_episode:
                ...
                self.write_log(i_episode, avg_loss, avg_score_window)
