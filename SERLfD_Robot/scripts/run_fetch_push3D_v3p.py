...
from envs.fetch.pushing3D_env_acc_fetch_3 import fetchPush3DEnv as fetchGraspingProceduralEnv
...
parser.add_argument(
    "--robot-env-config",
    type=str,
    default=os.getcwd() + "/../config/fetch_serl_push3d_env_acc_3.yaml",
