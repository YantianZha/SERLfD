...
def begin_graphics(width=640, height=480, color=formatColor(0, 0, 0), title=None):
    ...
    _root_window.geometry('%dx%d+%d+%d' % (width, height, 10, 0))
...
def getPostscript():
    """ return the postscript of the canvas """
    return _canvas.postscript(pageanchor='sw', y='0.c', x='0.c', pagewidth=_canvas_xs, pageheight=_canvas_ys)
