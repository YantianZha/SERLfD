...
if __name__ == '__main__':
    ...
    if not opts.textDisplay:
        from pacman_src import graphicsGridworldDisplay, valueIterationAgents, graphicsUtils, mdp, util
    ...
    if opts.agent == 'value':
        ...
        class RandomAgent:
            ...
            def getPolicy(self, state):
                "NOTE: 'random' is a special controller_policy value; don't use it in your code."
                return 'random'
