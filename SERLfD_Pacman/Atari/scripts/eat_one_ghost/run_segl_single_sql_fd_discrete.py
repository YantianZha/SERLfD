...
wandb_project_name = 'pacman-eat-2-ghost'

"""
demo_dir = 'experiment_results/pacman_eat_1_ghost_demo_5/'
demo_expr_id = 'eat_1_ghost_5_demo_aggressive_2'
"""
demo_dir = '../../experiment_results/pacman_eat_2_ghost_demo_5/'
demo_expr_id = 'eat_2_ghost_5_demo_aggressive_0'
...
def run_game():
    ...
    config_file = '../../experiment_configs/expr_pacman_eat_2_ghost.cnf'
    ...
    policy_hyper_params = Dict(dict(gamma=0.99,
                                    ...
                                    # LfD Setting
                                    margin=0.8,
                                    pretrain_step=int(3e3),  # the paper use 1,000,000 mini-batch updates
    ...
    hyper_params = Dict(dict(buffer_size=int(1e4),  # size of (sampled/expert) trajectories buffer
                             ...
                             max_traj_length=3000,  # maximum length of a single rollout
    ...
    network_cfg = Dict(dict(use_cnn=True,
                            ...
                            fc_hidden_sizes=[512, 512],
                            fc_hidden_activation=torch.relu))
    optim_cfg = Dict(dict(lr_explainer=1e-4, weight_decay=1e-6))
