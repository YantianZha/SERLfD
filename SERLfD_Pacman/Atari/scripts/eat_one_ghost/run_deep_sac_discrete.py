...
"""
experiment_name = 'sac-freeway'
wandb_project_name = 'freeway'
"""
"""
experiment_name = 'sac-lunar-lander'
wandb_project_name = 'lunar-lander-discrete'
"""
...
def run_game():
    ...
    hyper_params = Dict(dict(gamma=0.99,
                             ...
                             frame_stack=3,
                             # N-Step Buffer
                             n_step=10,  # if n_step <= 1, use common replay buffer otherwise n_step replay buffer
    ...
    sac_agent = SAC_Discrete_Agent(env, args, log_cfg, hyper_params, network_cfg, optim_cfg, logger=expr_logger)
