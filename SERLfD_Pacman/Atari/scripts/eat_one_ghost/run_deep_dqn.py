...
def parse_args():
    ...
    parser.add_argument("--save-period", type=int, default=8000,
...
def run_game():
    ...
    policy_hyper_params = Dict(dict(gamma=0.99,
                                    ...
                                    # Epsilon Greedy
                                    max_epsilon=1.0,
                                    min_epsilon=0.01,  # default (open-ai): 0.01
    ...
    dqn_agent = DQNAgent(env, policy_args, policy_log_cfg, policy_hyper_params,
