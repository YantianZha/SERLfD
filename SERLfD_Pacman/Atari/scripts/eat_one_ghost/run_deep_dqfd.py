...
def run_game():
    ...
    env = PytorchImage(eatGhostPacmanGymEnv.EatGhostPacmanGymEnv(config_file), is_to_gray=True, is_normalize=False, rescale=None, resize=[84, 84], binary_threshold=1)
    ...
    dqfd_agent = DQfDAgent(env, policy_args, policy_log_cfg, policy_hyper_params,
