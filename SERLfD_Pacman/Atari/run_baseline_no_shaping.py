...
from learning_agents.controller_policy.segl_sql_fd_discrete_predicate_policy import \
    SEGL_SQLfD_Discrete_Predicate_Policy, SEGL_SQLfD_No_Shaping_Policy
...
experiment_name = 'segl-sql-fd-no-shaping'
...
def run_game():
    ...
    sql_fd_policy = SEGL_SQLfD_No_Shaping_Policy(env, policy_args, policy_log_cfg,  policy_hyper_params,
